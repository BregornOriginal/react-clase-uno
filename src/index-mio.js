...
// ReactDOM.render(
//   <MatchNombre nombre='5' />, document.getElementById('react-app')
// )

// ReactDOM.render(
//   <PasswordInput minLength={5} />, document.getElementById('react-app')
// )

ReactDOM.render(
  <ValidationInput validation={(value) => value ? true : false} />, document.getElementById('react-app')
)
